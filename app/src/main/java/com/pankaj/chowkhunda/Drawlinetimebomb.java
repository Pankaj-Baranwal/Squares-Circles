...
/**
 * Created by Pankaj on 18-12-2014.
 */
public class Drawlinetimebomb extends View {
    ...
    int[] squares;
    int crow;
    String uscore, ascore;
    int userscore=0, andscore=0;
    int[] xposs, yposs;
    float xdiff = 0;
    float ydiff = 0;
    float yused[][];
    ...
    public Drawlinetimebomb(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void setupDrawing() {
        ...
        if(sp.contains("uname1"))
            uscore = sp.getString("uname1", "User");
        else
            uscore="User";
        ascore="Android:";
        ...
        xposs = new int[8];
        yposs = new int[8];
        int color1 = Color.rgb(250, 250, 10);
        int paintColor = 0xFF9400D3;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(totxm==0&& totym==0){
            if(userscore>andscore){
                eve.over(0);
            }
            else if(andscore>userscore){
                eve.over(1);
            }
            else eve.over(2);
        }
    ...
    private void clouse1(){
        if (clouse == 1) {
            ...
            if (dirt != 1) {
                if (squares.length > 1) {
                    for (int zues = 0; zues < squares.length - 1; zues++) {
                        if (zues == 0) {
                            if (squares[zues] <= squares[zues + 1])
                                crow = zues;
                            else crow = zues + 1;
                        } else {
                            if (squares[zues + 1] != 0) {
                                if (!(squares[crow] <= squares[zues + 1]))
                                    crow = zues + 1;
                            }
                        }
                    }
        ...
        if (xa == xb) {
            ...
            if (left == 0 && right == 0){
                if ((xleftx[l - 1][0] != 0) && (xleftx[l + cols - 2][0] == 0) && (yleftx[m - rows + 1][0] == 0))
                    xposs[0]=1;
                else if ((xleftx[l - 1][0] == 0) && (xleftx[l + cols - 2][0] != 0) && (yleftx[m - rows + 1][0] == 0)) xposs[0]=1;
                else if ((xleftx[l - 1][0] == 0) && (xleftx[l + cols - 2][0] == 0) && (yleftx[m - rows + 1][0] != 0)) yposs[0]=1;
                else {xposs[0]=0; yposs[0]=0;}
                if ((xleftx[l][0] != 0) && (xleftx[l + cols - 1][0] == 0) && (yleftx[m + rows - 1][0] == 0)) xposs[1]=1;
                else if ((xleftx[l][0] == 0) && (xleftx[l + cols - 1][0] != 0) && (yleftx[m + rows - 1][0] == 0)) xposs[1]=1;
                else if ((xleftx[l][0] == 0) && (xleftx[l + cols - 1][0] == 0) && (yleftx[m + rows - 1][0] != 0)) yposs[1]=1;
                else {xposs[1]=0; yposs[1]=0;}
            }
            else if (left == 1){
                if ((xleftx[l][0] != 0) && (xleftx[l + cols - 1][0] == 0) && (yleftx[m + rows - 1][0] == 0)) xposs[2]=1;
                else if ((xleftx[l][0] == 0) && (xleftx[l + cols - 1][0] != 0) && (yleftx[m + rows - 1][0] == 0)) xposs[2]=1;
                else if ((xleftx[l][0] == 0) && (xleftx[l + cols - 1][0] == 0) && (yleftx[m + rows - 1][0] != 0)) yposs[2]=1;
                else {xposs[2]=0; yposs[2]=0;}
            }
            else {
                if ((xleftx[xloc((xa - (2 * xdiff)), ya)][0] != 0) && (xleftx[xloc((xa - (2 * xdiff)), (ya + 2 * ydiff))][0] == 0) && (yleftx[m - rows+1][0] == 0)) xposs[3]=1;
                else if ((xleftx[xloc((xa - (2 * xdiff)), ya)][0] == 0) && (xleftx[xloc((xa - (2 * xdiff)), (ya + 2 * ydiff))][0] != 0) && (yleftx[m - rows+1][0] == 0)) xposs[3]=1;
                else if ((xleftx[xloc((xa - (2 * xdiff)), ya)][0] == 0) && (xleftx[xloc((xa - (2 * xdiff)), (ya + 2 * ydiff))][0] == 0) && (yleftx[m - rows +1][0] != 0)) yposs[3]=1;
                else {xposs[3]=0; yposs[3]=0;}
            }
        } else if (ya == yb) {
            int top, bottom;
            top = 0;
            ...
            int m = xloc(xa, ya);
            if (top == 0 && bottom == 0){
                if (((yleftx[l - 1][0] != 0) && (yleftx[l + rows - 2][0] == 0) && (xleftx[m - cols + 1][0] == 0))) yposs[4]=1;
                else if (((yleftx[l - 1][0] == 0) && (yleftx[l + rows - 2][0] != 0) && (xleftx[m - cols + 1][0] == 0))) yposs[4]=1;
                else if (((yleftx[l - 1][0] == 0) && (yleftx[l + rows - 2][0] == 0) && (xleftx[m - cols + 1][0] != 0))) xposs[4]=1;
                else {xposs[4]=0; yposs[4]=0;}
                if ((yleftx[l][0] != 0) && (yleftx[l + rows - 1][0] == 0) && (xleftx[m + cols - 1][0] == 0)) yposs[5]=1;
                else if ((yleftx[l][0] == 0) && (yleftx[l + rows - 1][0] != 0) && (xleftx[m + cols - 1][0] == 0)) yposs[5]=1;
                else if ((yleftx[l][0] == 0) && (yleftx[l + rows - 1][0] == 0) && (xleftx[m + cols - 1][0] != 0)) xposs[5]=1;
                else {xposs[5]=0; yposs[5]=0;}
            }
            else if (top == 1){
                if ((yleftx[l][0] != 0) && (yleftx[l + rows - 1][0] == 0) && (xleftx[m + cols - 1][0] == 0)) yposs[6]=1;
                else if ((yleftx[l][0] == 0) && (yleftx[l + rows - 1][0] != 0) && (xleftx[m + cols - 1][0] == 0)) yposs[6]=1;
                else if ((yleftx[l][0] == 0) && (yleftx[l + rows - 1][0] == 0) && (xleftx[m + cols - 1][0] != 0)) xposs[6]=1;
                else {yposs[6]=0; xposs[6]=0;}
            }
            else{
                if ((yleftx[yloc(xa, (ya - (2 * ydiff)))][0] != 0) && (yleftx[yloc((xa + (2 * xdiff)), (ya - 2 * ydiff))][0] == 0) && (xleftx[m - cols+1][0] == 0)) yposs[7]=1;
                else if ((yleftx[yloc(xa, (ya - (2 * ydiff)))][0] == 0) && (yleftx[yloc((xa + (2 * xdiff)), (ya - 2 * ydiff))][0] != 0) && (xleftx[m - cols+1][0] == 0)) yposs[7]=1;
                else if ((yleftx[yloc(xa, (ya - (2 * ydiff)))][0] == 0) && (yleftx[yloc((xa + (2 * xdiff)), (ya - 2 * ydiff))][0] == 0) && (xleftx[m - cols + 1][0] != 0)) xposs[7]=1;
                else {yposs[7]=0; xposs[7]=0;}
            }
        }
    }
